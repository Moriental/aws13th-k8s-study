...
## 1. Helm release 확인
<img width="1743" height="96" alt="image" src="https://github.com/user-attachments/assets/cb7a91a4-e93c-4e70-8777-ab1a629b413d" />


## 2. Pod 확인

<img width="1259" height="269" alt="image" src="https://github.com/user-attachments/assets/873883f6-de96-4bd9-b905-5f55e37707b1" />


Argo CD 관련 Pod들이 생성되어야 한다.


## 3. template 파일 확인

<img width="1275" height="72" alt="image" src="https://github.com/user-attachments/assets/26abb780-8ff7-4bfb-9086-f5f8afaf2cfa" />
...
이 문제는 Kubernetes YAML을 직접 작성하는 문제가 아니다.

핵심은 Helm 명령어를 문제 조건에 맞게 조립하는 것이다.
...
```bash
helm template <release-name> <repo/chart> --version <version> -n <namespace> --set <key>=<value> > <file>
helm install <release-name> <repo/chart> --version <version> -n <namespace> --set <key>=<value>
```
